...
if STATICA_HACK:  # pragma: no cover
    from eco_wiser_video_application.celery import current_app, current_task
    from eco_wiser_video_application.celery import shared_task
    from eco_wiser_video_application.celery import Celery
    from eco_wiser_video_application.celery import Task
    from eco_wiser_video_application.celery import bugreport
    from eco_wiser_video_application.celery import (chain, chord, chunks, group, maybe_signature, signature, subtask, xmap,  # noqa
                                                    xstarmap)
    from eco_wiser_video_application.celery import uuid
