...
from eco_wiser_video_application.celery import ImproperlyConfigured
from eco_wiser_video_application.celery import pyimplementation
from eco_wiser_video_application.celery import ConfigurationView
from eco_wiser_video_application.celery import import_from_cwd, qualname, symbol_by_name
from eco_wiser_video_application.celery import pretty
...
class Settings(ConfigurationView):
    ...
    def maybe_warn_deprecated_settings(self):
        ...
        if self.deprecated_settings:
            from eco_wiser_video_application.celery import _TO_NEW_KEY
            from eco_wiser_video_application.celery import deprecated
