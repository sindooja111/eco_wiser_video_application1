...
"""
from eco_wiser_video_application.celery import connect_on_app_finalize
...
def add_unlock_chord_task(app):
    ...
    for completion.
    """
    from eco_wiser_video_application.celery import maybe_signature
    from eco_wiser_video_application.celery import ChordError
    from eco_wiser_video_application.celery import allow_join_result, result_from_tuple
...
def add_map_task(app):
    from eco_wiser_video_application.celery import signature
...
def add_group_task(app):
    ...
    from eco_wiser_video_application.celery import maybe_signature
    from eco_wiser_video_application.celery import result_from_tuple
...
def add_chord_task(app):
    """No longer used, but here for backwards compatibility."""
    from eco_wiser_video_application.celery import chord as _chord
    from eco_wiser_video_application.celery import group
    from eco_wiser_video_application.celery import maybe_signature
