...
from eco_wiser_video_application.celery import current_app, states
from eco_wiser_video_application.celery import _task_stack
from eco_wiser_video_application.celery import _chain, group, signature
from eco_wiser_video_application.celery import Ignore, ImproperlyConfigured, MaxRetriesExceededError, Reject, Retry
from eco_wiser_video_application.celery import class_property
from eco_wiser_video_application.celery import EagerResult, denied_join_result
from eco_wiser_video_application.celery import abstract
from eco_wiser_video_application.celery import mattrgetter, maybe_list
from eco_wiser_video_application.celery import instantiate
from eco_wiser_video_application.celery import gethostname
from eco_wiser_video_application.celery import raise_with_context
...
class Task:
    ...
    def bind(cls, app):
        ...
        if not was_bound:
            ...
            from eco_wiser_video_application.celery import LocalStack
    ...
    def apply(self, args=None, kwargs=None,
        ...
        from eco_wiser_video_application.celery import build_tracer
