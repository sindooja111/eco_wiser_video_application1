...
from eco_wiser_video_application.celery import platforms, signals
from eco_wiser_video_application.celery import (_announce_app_finalized, _deregister_app, _register_app, _set_current_app, _task_stack,
                                                connect_on_app_finalize, get_current_app, get_current_worker_task, set_default_app)
from eco_wiser_video_application.celery import AlwaysEagerIgnored, ImproperlyConfigured
from eco_wiser_video_application.celery import get_loader_cls
from eco_wiser_video_application.celery import PromiseProxy, maybe_evaluate
from eco_wiser_video_application.celery import abstract
from eco_wiser_video_application.celery import AttributeDictMixin
from eco_wiser_video_application.celery import Signal
from eco_wiser_video_application.celery import first, head_from_fun, maybe_list
from eco_wiser_video_application.celery import gen_task_name, instantiate, symbol_by_name
from eco_wiser_video_application.celery import get_logger
from eco_wiser_video_application.celery import FallbackContext, mro_lookup
from eco_wiser_video_application.celery import maybe_make_aware, timezone, to_utc
...
class Celery:
    ...
    def start(self, argv=None):
        ...
        """
        from eco_wiser_video_application.celery import celery
    ...
    def setup_security(self, allowed_serializers=None, key=None, key_password=None, cert=None,
        ...
        """
        from eco_wiser_video_application.celery import setup_security
    ...
    @cached_property
    def _canvas(self):
        from eco_wiser_video_application.celery import canvas
        return canvas
