"""Celery Application."""
from eco_wiser_video_application.celery import _state
from eco_wiser_video_application.celery import Proxy
...
def shared_task(*args, **kwargs):
    ...
    Example:
        ...
        >>> from eco_wiser_video_application.celery import Celery, shared_task
        >>> @shared_task
        ... def add(x, y):
        ...     return x + y
        ...
