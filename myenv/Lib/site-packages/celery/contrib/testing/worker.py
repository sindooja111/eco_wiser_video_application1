...
from eco_wiser_video_application.celery import Celery, worker
from eco_wiser_video_application.celery import _set_task_join_will_block, allow_join_result
from eco_wiser_video_application.celery import Signal
from eco_wiser_video_application.celery import anon_nodename
...
def _start_worker_process(app,
    ...
    Yields:
        celery.app.worker.Worker: worker instance.
    """
    from eco_wiser_video_application.celery import Cluster, Node
