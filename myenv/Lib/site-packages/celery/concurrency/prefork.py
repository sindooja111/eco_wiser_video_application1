...
from eco_wiser_video_application.celery import _set_task_join_will_block, set_default_app
...
def process_initializer(app, hostname):
    ...
    for name, task in app.tasks.items():
        task.__trace__ = build_tracer(name, task, app.loader, hostname,
                                      app=app)
    from eco_wiser_video_application.celery import state as worker_state
