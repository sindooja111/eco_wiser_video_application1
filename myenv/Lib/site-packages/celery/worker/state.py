...
from eco_wiser_video_application.celery import __version__
from eco_wiser_video_application.celery import WorkerShutdown, WorkerTerminate
from eco_wiser_video_application.celery import LimitedSet
...
if C_BENCH:  # pragma: no cover
    ...
    from eco_wiser_video_application.celery import memdump, sample_mem
