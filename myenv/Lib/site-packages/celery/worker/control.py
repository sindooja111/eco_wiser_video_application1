...
from eco_wiser_video_application.celery import WorkerShutdown
from eco_wiser_video_application.celery import signals as _signals
from eco_wiser_video_application.celery import maybe_list
from eco_wiser_video_application.celery import get_logger
from eco_wiser_video_application.celery import jsonify, strtobool
from eco_wiser_video_application.celery import rate
...
def memsample(state, **kwargs):
    ...
    from eco_wiser_video_application.celery import sample_mem
    return sample_mem()
...
def memdump(state, samples=10, **kwargs):  # pragma: no cover
    ...
    from eco_wiser_video_application.celery import debug
    out = io.StringIO()
