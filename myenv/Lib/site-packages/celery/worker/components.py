...
from eco_wiser_video_application.celery import _set_task_join_will_block
from eco_wiser_video_application.celery import ImproperlyConfigured
from eco_wiser_video_application.celery import IS_WINDOWS
...
class Beat(bootsteps.StartStopStep):
    ...
    def create(self, w):
        from eco_wiser_video_application.celery import EmbeddedService
