...
from eco_wiser_video_application.celery import LOG_LEVEL, CeleryDaemonCommand, CeleryOption, handle_preload_options
from eco_wiser_video_application.celery import detached, set_process_title, strargv
...
def _run_evdump(app):
    from eco_wiser_video_application.celery import evdump
...
def _run_evcam(camera, app, logfile=None, pidfile=None, uid=None,
               ...
               detach=False, **kwargs):
    from eco_wiser_video_application.celery import evcam
...
def _run_evtop(app):
    try:
        from eco_wiser_video_application.celery import evtop
