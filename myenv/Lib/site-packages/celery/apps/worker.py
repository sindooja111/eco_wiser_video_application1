...
from eco_wiser_video_application.celery import VERSION_BANNER, platforms, signals
from eco_wiser_video_application.celery import trace
from eco_wiser_video_application.celery import AppLoader
from eco_wiser_video_application.celery import EX_FAILURE, EX_OK, check_privileges
from eco_wiser_video_application.celery import static, term
from eco_wiser_video_application.celery import cry
from eco_wiser_video_application.celery import qualname
from eco_wiser_video_application.celery import get_logger, in_sighandler, set_in_sighandler
from eco_wiser_video_application.celery import pluralize
from eco_wiser_video_application.celery import WorkController
...
def _shutdown_handler(worker, sig='TERM', how='Warm',
    ...
    def _handle_request(*args):
        with in_sighandler():
            from eco_wiser_video_application.celery import state
...
def install_rdb_handler(envvar='CELERY_RDBSIG',
    ...
    def rdb_handler(*args):
        ...
        with in_sighandler():
            from eco_wiser_video_application.celery import _frame, set_trace
