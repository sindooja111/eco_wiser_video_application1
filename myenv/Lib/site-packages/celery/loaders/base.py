...
from eco_wiser_video_application.celery import reraise
from eco_wiser_video_application.celery import DictAttribute, force_mapping
from eco_wiser_video_application.celery import maybe_list
from eco_wiser_video_application.celery import NotAPackage, find_module, import_from_cwd, symbol_by_name
...
class BaseLoader:
    ...
    def cmdline_config_parser(self, args, namespace='celery',
        ...
        from eco_wiser_video_application.celery import NAMESPACES, Option
